...
def input_commands():
    ...
    fimo_command =  "fimo --oc <output location> --bgfile db/EnsemblBacteria/_candidatus_kapabacteria_thiocyanatum_gca_001899175_57.fna.bfile --thresh 1.0E-4 motifs.meme db/EnsemblBacteria/_candidatus_kapabacteria_thiocyanatum_gca_001899175_57.fna "
