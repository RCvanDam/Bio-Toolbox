from FIMO_MEME_Commandline import Fimo
import os
...
fimo = Fimo(HUMAN_DATABASE_OPTION_, 
            0.001, 
            False, 
            HUMAN_DATABASE_OPTION_, "/home/mooncake/Documents/git_stuff/Bio-Toolbox/app_prototype/meme_sample_sequences.fasta", 
            "/home/mooncake/Documents/git_stuff/Bio-Toolbox/app_prototype/User_output/fimo")
