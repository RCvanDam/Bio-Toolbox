...
def home_about_page():
    ...
    if request.method == "GET":
        ...
        return render_template("Inheritance_test/prototype_bootstrap.html")#basically the first time the homepage loads or if the page gets reloaded without user inputs.
